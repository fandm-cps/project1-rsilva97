...
TEST_CASE("Testing ReallyLongInt Class"){
    ...
    SECTION("Equal"){
        ...
        test_rliNeg = new ReallyLongInt(-9);
        test_rliPos = new ReallyLongInt("8");
        test_otherNeg = new ReallyLongInt("-9");
        test_otherPos = new ReallyLongInt(*test_rliPos);
        test_another = new ReallyLongInt(9);
    ...
    SECTION("Greater"){
        ...
        test_otherNeg = new ReallyLongInt(*test_rliNeg);
        test_otherPos = new ReallyLongInt(*test_rliPos);
        test_another = new ReallyLongInt(256);
        ...
        test_another = new ReallyLongInt(9);
        REQUIRE(test_another->greater(*test_rliPos) == true);
        REQUIRE(test_rliPos->greater(*test_another) == false);
        delete test_another;

        test_another = new ReallyLongInt(4);
        REQUIRE(test_another->greater(*test_rliPos) == false);
